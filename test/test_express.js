...
// http://localhost:9528/beijingtyqyt/api/companies/getListByTenantId?timestamp=1594706762439&index=1&size=10&tenantId=27&keyword=

let baseUrl = '/beijingtyqy2/api'
let companies = require('./routes/companies')
app.use(baseUrl + '/companies', companies)
app.all('*', function () {
